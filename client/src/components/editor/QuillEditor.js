...
class Clipboard extends QuillClipboard {
  ...
  async onPaste(e) {
    ...
    if (urlMatches.length > 0) {
      ...
      //console.log('when to use this') Usually, paste it elsewhere and then copy it..
      super.onPaste(e);
    }
  }
}
...
class FileBlot extends BlockEmbed {
  static create(value) {
    ...
    //The file name appears above the attachment text using the b tag.
    ...
    //linkTag Comes out like this
    // <a href="btn_editPic@3x.png" target="_blank" classname="file-link-inner-post"><b>btn_editPic@3x.png</b></a>
...
class QuillEditor extends React.Component {
  ...
  // When I V F P is pressed, go to insertImage: this.imageHandler and click inputOpenImageRef there.
  imageHandler = () => {
    ...
    if (
      ...
      axios.post("/api/blog/uploadfiles", formData, config).then((response) => {
        if (response.data.success) {
          ...
          // First, put the image in the node server, then put it in src below here.
          // Go to the image blot and create the image, create it, take src and alt from the valuation and put it in editorHTML.
  ...
  modules = {
    ...
    toolbar: {
      container: "#toolbar",
      //id ="toorbar"Is where B I U S I V F P is.
      handlers: {
